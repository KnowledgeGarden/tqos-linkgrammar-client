 ...
 *
 */
public class H implements ICodeInterpreter {
	 ...
	 * 
	 */
	public H(LinkGrammarClientEnvironment env, LinkGrammarInterpreter interp) {
		environment = env;
		interpreter = interp;
	...
	/**
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-H.html
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-HA.html
	 * @param which
	 * @param code
	 * @param link
	 * @param f
