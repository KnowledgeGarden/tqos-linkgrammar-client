 ...
 *
 */
public class K implements ICodeInterpreter {
	 ...
	 * 
	 */
	public K(LinkGrammarClientEnvironment env, LinkGrammarInterpreter interp) {
		environment = env;
		interpreter = interp;
	...
	/**
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-K.html
	 * @param which
	 * @param code
	 * @param link
	 * @param f
