 ...
 *
 */
public class W implements ICodeInterpreter {
	 ...
	 * 
	 */
	public W(LinkGrammarClientEnvironment env, LinkGrammarInterpreter interp) {
		environment = env;
		interpreter = interp;
	...
	/**
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-W.html
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-WN.html
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-WR.html
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-WV.html
	 * @param which
	 * @param code
	 * @param link
	 * @param f
