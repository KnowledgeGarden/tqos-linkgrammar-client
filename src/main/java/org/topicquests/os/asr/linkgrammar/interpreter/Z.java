 ...
 *
 */
public class Z implements ICodeInterpreter {
	 ...
	 * 
	 */
	public Z(LinkGrammarClientEnvironment env, LinkGrammarInterpreter interp) {
		environment = env;
		interpreter = interp;
	}

	/**
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-Z.html
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-ZZZ.html
	 * @param which
	 * @param code
	 * @param link
	 * @param f
