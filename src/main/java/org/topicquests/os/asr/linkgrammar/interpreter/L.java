 ...
 *
 */
public class L implements ICodeInterpreter {
	 ...
	 * 
	 */
	public L(LinkGrammarClientEnvironment env, LinkGrammarInterpreter interp) {
		environment = env;
		interpreter = interp;
	...
	/**
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-L.html
	 * @see https://www.abisource.com/projects/link-grammar/dict/section-LE.html
	 * https://www.abisource.com/projects/link-grammar/dict/section-LI.html
	 * @param which
	 * @param code
	 * @param link
	 * @param f
